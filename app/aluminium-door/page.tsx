...
export default function AluminiumDoorPage() {
  ...
  return (
    <main className="min-h-screen">
      <Hero
        title="Aluminium Door Calculator"
        subtitle="Configure bathroom aluminium doors with chaukhat, accessories, and optional finishes. Get accurate pricing in real-time."
        mediaType="image"
        ...
        <div className="container mx-auto px-4 sm:px-6 md:px-8 relative z-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
            <div className="border border-[var(--muted)]/20 p-6 bg-black/20 backdrop-blur-sm">
              ...
              <p className="text-3xl font-bold text-[var(--fg)]">{calculations.area} m²</p>
            </div>
            <div className="border border-[var(--muted)]/20 p-6 bg-black/20 backdrop-blur-sm">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
            <div className="space-y-6">
              ...
              <div>
                <label className="block text-sm font-medium mb-2 text-[var(--fg)]">Area</label>
                <p className="text-lg font-semibold text-[var(--fg)]">{calculations.area} Sqft</p>
              </div>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) => setSelectedThickness(e.target.value as AluminiumDoorThickness)}
                  className="w-full border border-[var(--muted)]/30 bg-[var(--bg)] px-4 py-3 text-[var(--fg)] focus:border-[var(--accent)] focus:outline-none transition-colors"
                >
            ...
            <div className="space-y-6">
              <div>
                <label className="block text-sm font-medium mb-4 text-[var(--fg)]">Options</label>
                <div className="space-y-3">
                  ...
                  <label className="flex items-center gap-3 cursor-pointer">
                    <input
                      ...
                      className="w-4 h-4 border-[var(--muted)]/30 bg-[var(--bg)]"
                    />
                    <span className="text-[var(--fg)]">Accessories</span>
                  </label>
                  <label className="flex items-center gap-3 cursor-pointer">
                    <input
                      type="checkbox"
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-[var(--muted)]/20">
                  <th className="border-r border-[var(--muted)]/20 p-4 text-left text-[var(--fg)]"></th>
                  <th className="border-r border-[var(--muted)]/20 p-4 text-center text-[var(--fg)]">1.2 MM</th>
                  <th className="border-r border-[var(--muted)]/20 p-4 text-center text-[var(--fg)]">1.6 MM</th>
                  <th className="p-4 text-center text-[var(--fg)]">1.2 MM Hindalco</th>
                </tr>
              </thead>
              <tbody>
          ...
          <div className="mb-8">
            ...
            <div className="border border-[var(--muted)]/20 overflow-x-auto">
              <table className="w-full">
                <tbody>
                  <tr className="border-b border-[var(--muted)]/10">
